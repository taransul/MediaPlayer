...
import com.example.mediaplayer.utils.util.EqualizerUtils
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == Constants.REQUEST_PERMISSION_READ_EXTERNAL_STORAGE_CODE
            && grantResults.isNotEmpty()
            && grantResults[0] == PackageManager.PERMISSION_DENIED
        ) {
            Toast.makeText(this, "PERMISSION_DENIED", Toast.LENGTH_SHORT)
                .show()
        }
    }
}